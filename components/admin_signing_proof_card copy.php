...
<div class="modal fade" id="open_modal_delete_proof" tabindex="-1" aria-labelledby="confirm_deleteLabel" aria-hidden="true">
...
?>
            <div class="document-upload row border" id="<?php echo "card_" . $doc_type ?>">
                ...
                <div class="col file-info text-overflow-ellipsis">
                    ...
                    style = "display:none" class="btn btn-warning">Update</button>
...
<button type="button" 
id="open_modal_delete_proof" data-bs-toggle="modal" data-bs-target="#modal_delete_proof"
...
name = "open_modal_delete_proof" class = "modal-delete-proof btn btn-danger"
>
    ...
    DELETE
        ...
        <div class="col empty">
            ...
            <div class="col file-info text-overflow-ellipsis">
                ...
                <button id="<?php echo "upload_btn_" . $doc_type ?>" type="button" onclick="insert_document_proof('<?php echo 'form_insert_' . $doc_type ?>')" class="btn my-btn-blue">Upload</button>


                <button id="<?php echo "cancel_" . $doc_type ?>" 
                    type = "button"
                    onclick="refresh_parent(this.id)" style="display:none" class="btn btn-secondary">Cancel
                </button>
