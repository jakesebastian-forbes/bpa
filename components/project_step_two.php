...
<div id="step_two_forms">
    <ul class="nav nav-pills mb-0 nav-fill border border-bottom-0 m-2 p-3 " id="forms" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="building_permit_tab" data-bs-toggle="pill" data-bs-target="#building_permit" type="button" role="tab" aria-controls="building_permit" aria-selected="false">Building Premit</button>
        </li>

        <li class="nav-item" role="presentation">
            <button class="nav-link " id="locational_clearance_tab" data-bs-toggle="pill" data-bs-target="#locational_clearance" type="button" role="tab" aria-controls="locational_clearance" aria-selected="true">Locational Clearance</button>
        </li>
    ...
    <div class="tab-pane fade show active" id="building_permit" role="tabpanel" aria-labelledby="building_permit_tab" tabindex="0">
            <!-- BUILDING PERMIT -->
            <?php require "form_unified.php"; ?>
        </div>
  
    
    <div class="tab-pane fade " id="locational_clearance" role="tabpanel" aria-labelledby="locational_clearance_tab" tabindex="0">
